...
exports.ReceiptsModule = ReceiptsModule = __decorate([
    (0, common_1.Module)({ controllers: [receipts_controller_1.ReceiptsController], providers: [receipts_service_1.ReceiptsService], exports: [receipts_service_1.ReceiptsService] })
], ReceiptsModule);
